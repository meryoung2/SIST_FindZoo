...
<script type="text/javascript">
	...
	function confirm_del(board_num){
		...
		if(re){
			location.href = "/deleteFindReview.do?board_num="+board_num;	
		}
	}
	...
	var re = confirm("댓글을 삭제하시겠습니까?");
		if(re==true){
			location.href="findReviewDeleteReply.do?board_num="+board_num+"&reply_num="+reply_num;
		}
	}
...
<jsp:include page="findZoo_Header.jsp"/>
	...
	<div class="modal fade" id="updateReply" tabindex="-1" aria-labelledby="updateReplyLabel" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <form action="/member/findReviewUpdateReply.do" method="post">
	...
	<div class="modal fade" id="reReply" tabindex="-1" aria-labelledby="reReplyLabel" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <form action="/member/findReviewReReply.do" method="post">
	      <div class="modal-header">
