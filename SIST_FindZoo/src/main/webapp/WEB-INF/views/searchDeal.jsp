...
<script type="text/javascript">
	function btn_start(){
		location.href = "searchDeal.do?pageNum=1";
	}
	
	function btn_end(totalPage){
		location.href = "searchDeal.do?pageNum="+totalPage;
	}
	...
	function btn_prev(listStart, listEnd){
		...
		location.href = "searchDeal.do?pageNum="+listEnd;
	}
	...
	function btn_next(listStart, listEnd, totalPage){
		...
		location.href = "searchDeal.do?pageNum="+listStart;
	}
</script>
</head>
<body>
