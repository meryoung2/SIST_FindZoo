...
<script type="text/javascript">
	function btn_start(){
		location.href = "vol.do?pageNum=1";
	}
	
	function btn_end(totalPage){
		location.href = "vol.do?pageNum="+totalPage;
	}
	...
	function btn_prev(listStart, listEnd){
		...
		location.href = "vol.do?pageNum="+listEnd;
	}
	...
	function btn_next(listStart, listEnd, totalPage){
		if(listEnd != totalPage){
			...
			location.href = "vol.do?pageNum="+listStart;
		}else{
			location.reload();
		}
	}
				...
				<table border="1" class="table table-hover">
					...
					<tbody>
						<c:forEach var="v" items="${ list }">
							<tr>
								<td width="60%">&nbsp;&nbsp;&nbsp;<a
									href="detailVol.do?board_num=${ v.board_num }">${ v.title }</a>
								</td>
								...
								<td width="10%" style="text-align: center;">${ v.views }</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
