	...
	<div id="find-container">
		<div id="content">
			...
			<label class="form-label mt-4">실종날짜</label>
				<input class="form-control" type="date" name="find_lost_date" id="find_lost_date" required="required" style="width: 30%;">
				...
				<input class="form-control" type="number" name="find_reward" required="required" value="${f.find_reward }" style="width: 15%;">
				<label class="form-label mt-4">내용</label>
				<textarea class="form-control" rows="15" name="content" required="required" style="width: 100%;">${f.content}</textarea>
