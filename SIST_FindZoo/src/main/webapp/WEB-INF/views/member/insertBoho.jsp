		...
		<div id="content">
			...
			<form class="form-group" action="/member/insertBoho.do" method="post" enctype="multipart/form-data">
				...
				<script>
					...
					function getAddr() {
						var boho_find_loc = document.getElementById('addr1').value;
						console.log('가져온 텍스트', boho_find_loc);
				...
				<input class="form-control" type="date" name="boho_find_date" id="boho_find_date" style="width: 30%;">
				...
				<label for="boho_pet_etc">기타</label>
				<input type="radio" class="form-check-input" name="boho_pet" id="boho_pet_etc" value="기타"><br>
