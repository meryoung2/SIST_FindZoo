...
<script type="text/javascript">
			...
			if(confirm("선택한 쪽지를 삭제하시겠습니까?")) {
				...
				$.ajax({
					...
					success : function(re){
						if(re == 1) {
							// 성공적으로 삭제 되었다면 새로고침
							location.href = "/sendNoteList.do?note_sender_num="+note_sender_num;
						}else {
	...
	function detailSendNote(note_num) {
		...
		window.open("detailSendNote.do?note_num="+note_num, "_blank", "width=420, height=370, left="+popupX+", top="+popupY);
	}
</script>
</head>
<body>
